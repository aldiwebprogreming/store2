			...
			<div class="col-sm-8">
				<div class="card">
				  ...
				  <div class="card-body">
				  	...
				  	<h5 style="color: silver"><?= $data['kategori'] ?></h5>
				  		...
				  		<div class="row">
				  			<div class="col-sm-3">
				  				<div class="form-group">
				  					...
				  					<input type="text" name="prov" value="<?= $val['PROVINSI'] ?>" class="form-control" readonly="">
				  				</div>
				  			</div>
				  			...
				  			<div class="col-sm-3">
				  				<div class="form-group">
				  					...
				  					<input type="text" name="kab" value="<?= $val['KABUPATEN'] ?>" class="form-control" readonly="">
				  				</div>
				  			</div>
				  			...
				  			<div class="col-sm-3">
				  				<div class="form-group">
				  					...
				  					<input type="text" name="kec" value="<?= $val['KECAMATAN'] ?>" class="form-control" readonly="">
				  				</div>
				  			</div>
				  			...
				  			<div class="col-sm-3">
				  				<div class="form-group">
				  					...
				  					<input type="text" name="kel" value="<?= $val['KELURAHAN'] ?>" class="form-control" readonly="">
				  				</div>
				  			</div>
